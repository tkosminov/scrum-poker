...
export type TaskUpdateEventSubscription = { taskUpdateEvent: { id: string, room_id: string, title: string, voting_status_id: string, closest_point: number | null, avg_point: number | null } };
